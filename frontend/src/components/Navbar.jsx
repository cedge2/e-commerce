...
const Navbar = () => {
    ...
    return (
        ...
        backdrop-blur-md shadow-lg z-40 transition-all duration-300 border-b border-emerald-800'>
                ...
                <div className='flex flex-wrap justify-between items-center'>
                    ...
                    <nav className='flex flex-wrap items-center gap-4'>
                        ...
                        {user ? (
                            ...
                            <>
                                <Link 
                                    to={"/signup"} className='bg-emerald-600 hover:bg-emerald-700 text-white py-2 px-4 
                                ...
                                <Link 
                                    to={"/login"} className='bg-gray-700 hover:bg-gray-600 text-white py-2 px-4 
                                    rounded-md flex items-center transition duration-300 ease-in-out'
                                >
